...
/**
 * handle_print_charec - Print a character
 * @value_types: List of arguments
 * @buffer_list: Buffer array for printing
 * @flags_value: Active flags
 * @width_value: Width specification
 * @precision_value: Precision specification
 * @size_value: Size specifier
...
int handle_print_string(va_list value_types, char buffer_list[],
	int flags_value, int width_value, int precision_value, int sisize_valueze)
{
	int lenG = 0, index;
